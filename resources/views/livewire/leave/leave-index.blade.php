<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
            @can('report.export')
                <button wire:click="export" class="bg-green-600 text-white px-4 py-2 rounded shadow text-sm">Export All</button>
            @endcan
            <a href="{{ route('leave.request') }}" class="bg-indigo-600 text-white px-4 py-2 rounded shadow hover:bg-indigo-700 text-sm">Request Leave</a>
        </div>
    </div>
