<div class="max-w-5xl mx-auto space-y-8">
    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex justify-between items-center">
        ...
        <div class="flex gap-2">
             @if($review->status === 'hr_calibration')
    ...
    <div class="bg-slate-900 p-8 rounded-3xl shadow-xl text-white">
        <h3 class="text-lg font-bold mb-6 border-b border-slate-800 pb-4">HR Calibration</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Calibration Remarks</label>
